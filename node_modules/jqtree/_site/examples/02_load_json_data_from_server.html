...
<html>
    <head>
        <meta charset="utf-8">
        <title>Load json data from the server in javascript tree</title>
        ...
        <link rel="stylesheet" href="/static/bower_components/pygments/css/monokai.css">
...
<div class="highlight"><pre><code class="language-js" data-lang="js"><span class="nx">$</span><span class="p">(</span><span class="s1">&#39;#tree1&#39;</span><span class="p">).</span><span class="nx">tree</span><span class="p">();</span></code></pre></div>
...
<script src="/static/bower_components/jquery-mockjax/jquery.mockjax.js"></script>
<script src="/static/example_data.js"></script>


<script src="/static/examples/load_json_data_from_server.js"></script>
