...
function (_HTMLElement) {
  ...
  function SimpleteForm(self) {
    ...
    self = _this = _possibleConstructorReturn(this, _getPrototypeOf(SimpleteForm).call(this, self));
