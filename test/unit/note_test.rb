...
class NoteTest < ActiveSupport::TestCase
  ...
  test 'should parse turtle note annotations' do
    ...
    concept.notes << ::Note::SKOS::ChangeNote.new.from_annotation_list!(str)

    assert_equal 1, Note::SKOS::ChangeNote.count, 1
    assert_equal 3, Note::SKOS::ChangeNote.first.annotations.count, 3
    assert_equal 1, Note::Annotated::Base.where(:namespace => 'umt', :predicate => 'thsisn', :value => '"00000001"').count
  end
