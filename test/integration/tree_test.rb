...
class TreeTest < ActionDispatch::IntegrationTest
  ...
  test "Browse hierarchical concepts tree" do
    ...
    assert !page.has_content?(narrower_concept.pref_label.to_s), "Narrower relation (#{narrower_concept.pref_label}) shouldn't be visible in the hierarchical concepts list"
  end
