...
boot:
  ...
  car:
    ...
    get :index, params: { lang: 'en', format: 'ttl' }
    assert_response 200
  ...
  test 'permission handling' do
    get :show, params: { lang: 'en', format: 'html', root: 'root' }
  ...
  test 'caching' do
    ...
    get :show, params: { lang: 'en', format: 'ttl', root: 'root', published: 0 }
    assert_response 200
    assert @response.headers['Cache-Control'].include?('private')

    # ETag keyed on params

    get :show, params: { lang: 'en', format: 'ttl', root: 'root' , depth: 4 }
    assert_response 200
...
:bar a skos:Concept;
  ...
  test 'root parameter handling' do
    ...
    get :show, params: { lang: 'en', format: 'html', root: 'N/A' }
    assert_response 404
    ...
    get :show, params: { lang: 'en', format: 'html', root: 'bravo' }
    entries = get_entries('ul.concept-hierarchy > li')
  ...
  test 'depth handling' do
    ...
    get :show, params: { lang: 'en', format: 'html', root: 'root', depth: 4 }
    entries = css_select(selector)
    assert_equal 2, entries.length

    get :show, params: { lang: 'en', format: 'html', root: 'root', depth: 1 }
    entries = get_entries('ul.concept-hierarchy > li')
    assert_equal ['Root'], entries
    entries = get_entries('ul.concept-hierarchy > li > ul > li')
    assert_equal ['Bar', 'Foo'], entries
    ...
    get :show, params: { lang: 'en', format: 'html', root: 'root', depth: 5 }
    assert_response 403
    assert_equal 'excessive depth', flash[:error]
    Iqvoc.config['performance.unbounded_hierarchy'] = old_config_value

    get :show, params: { lang: 'en', format: 'html', root: 'root', depth: 'invalid' }
    assert_response 400
  ...
  test 'direction handling' do
    ...
    get :show, params: { lang: 'en', format: 'html', root: 'root', dir: 'up' }
    entries = get_entries('ul.concept-hierarchy li')
    assert_equal ['Root'], entries
    ...
    get :show, params: { lang: 'en', format: 'html', root: 'lorem', dir: 'up' }
    entries = get_entries('ul.concept-hierarchy > li')
    assert_equal ['Lorem'], entries
    entries = get_entries('ul.concept-hierarchy li > ul > li > ul > li > ul > li')
    ...
    get :show, params: { lang: 'en', format: 'html', root: 'lorem', dir: 'up', depth: 4 }
  ...
  test 'siblings handling' do
    get :show, params: { lang: 'en', format: 'html', root: 'foo' }
    ...
    get :show, params: { lang: 'en', format: 'html', root: 'lorem', dir: 'up', siblings: 'true' }
    entries = get_all_entries('ul.concept-hierarchy li')
    ...
    get :show, params: { lang: 'en', format: 'html', root: 'lorem', dir: 'up', siblings: '1', depth: 4 }
    entries = get_all_entries('ul.concept-hierarchy li')
