...
class ConceptsController < ApplicationController
  ...
  def create
    ...
    if @concept.save
      flash[:info] = I18n.t("txt.controllers.versioned_concept.success")
  ...
  def update
    ...
    if @concept.update_attributes(params[:concept])
      flash[:info] = I18n.t("txt.controllers.versioned_concept.update_success")
  ...
  def destroy
    ...
    if @new_concept.destroy
      flash[:info] = I18n.t("txt.controllers.concept_versions.delete")
      redirect_to dashboard_path
    else
      flash[:info] = I18n.t("txt.controllers.concept_versions.delete_error")
